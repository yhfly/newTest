...
var ButtonChoice = /** @class */ (function (_super) {
    ...
    ButtonChoice.prototype.setup3 = function (e) {
        this.people = new People("honghong");
        this.people.sun();
        if (this.dengjiao != null) {
            this.dengjiao.stop();
    ...
    ButtonChoice.prototype.setup4 = function (e) {
        this.people = new People("mingming");
        this.people.sun();
        if (this.xinxing) {
            this.xinxing.stop();
            this.xinxing.graphics.clear();
...
//# sourceMappingURL=Draw_Choose.js.map